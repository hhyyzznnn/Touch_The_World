...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "5명 이상부터 진행 가능합니다. 소규모 교직원 연수·체험학습부터 대규모 학교 단체까지 인원에 맞게 맞춤 구성해 드립니다.",
  },
  {
    question: "나라장터(조달청)를 통한 계약이 가능한가요?",
    answer:
      "네, 터치더월드는 나라장터 및 학교장터 등록 업체입니다. 또한 소상공인·여성기업으로 등록되어 있어 5천만 원 이하 수의계약도 가능합니다. 공공기관·학교의 조달 구매 절차에 따른 계약을 지원하며, 관련 서류 준비도 함께 도와드립니다.",
  },
  {
    question: "여행 중 안전 관리는 어떻게 이루어지나요?",
    answer:
      "출발 전 사전 답사를 통해 안전 동선을 검토하고, 전원 여행자 보험에 가입합니다. 비상 연락망 및 위기 대응 매뉴얼도 운영합니다. 인솔자는 필요 여부에 따라 배치 유무를 선택하실 수 있으며, 인솔자 없이 진행하는 자율형 프로그램도 운영합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "국내외 전 세계를 대상으로 운영합니다. 일본(오사카·도쿄·히로시마·후쿠오카), 동남아시아, 유럽 등 원하시는 지역에 맞게 프로그램을 기획해 드립니다. 특성화고 해외 취업 연계 과정도 별도로 운영합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "교육여행은 수학여행보다 광범위한 개념입니다. 수학여행을 포함하여 체험학습·현장학습·교직원 연수·특성화고 직업 탐방 등 다양한 교육 목적의 여행 활동을 모두 포괄합니다. 터치더월드는 이 모든 형태를 기획·운영하며, 학교·기관의 교육 목적에 맞게 프로그램을 맞춤 설계합니다.",
  },
  {
