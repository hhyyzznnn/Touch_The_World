        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 sm:space-y-6 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 justify-center pt-4 sm:pt-6">
              ...
              <Button asChild size="lg" variant="outline" className="bg-white border-2 border-gray-300 hover:border-brand-green/50 hover:bg-brand-green/5 px-6 sm:px-8 py-3 sm:py-6 text-sm sm:text-lg text-text-dark rounded-xl transition-all duration-200">
            ...
            {PROGRAM_CATEGORIES.map((category) => {
              ...
              return (
                <Link
                  key={category.name}
                  href={category.href}
                  className="flex flex-col items-center p-4 sm:p-6 md:p-8 rounded-lg bg-white shadow-sm transform transition-all hover:shadow-md group"
                >
                  <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-brand-green/10 rounded-full flex items-center justify-center mb-2 sm:mb-4">
                    <Icon className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-brand-green" />
                  </div>
                  <span className="text-center text-text-dark text-sm sm:text-base md:text-lg" style={{ fontWeight: 350 }}>
                    {category.name}
                  </span>
                </Link>
              );
