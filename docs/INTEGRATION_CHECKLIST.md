...
3. `.env` 설정
   - 권장: `BIZM_USER_ID`, `BIZM_SENDER_KEY`, `BIZM_VERIFICATION_TEMPLATE_CODE` (`BIZM_USER_KEY` 선택)
   - 또는 호환키: `KAKAO_BM_CLIENT_ID`, `KAKAO_BM_CLIENT_SECRET`, `KAKAO_BM_SENDER_KEY`, `KAKAO_BM_VERIFICATION_TEMPLATE_CODE`
